...
namespace NBitcoin
{
    public class uint512
    {
        ...
        static readonly uint512 _Zero = new uint512();
        public static uint512 Zero
        {
            get { return _Zero; }
        }

        static readonly uint512 _One = new uint512(1);
        public static uint512 One 
        {
            get { return _One; }
        }
        ...
        internal readonly UInt32 pn8;
        internal readonly UInt32 pn9;
        internal readonly UInt32 pn10;
        internal readonly UInt32 pn11;
        internal readonly UInt32 pn12;
        internal readonly UInt32 pn13;
        internal readonly UInt32 pn14;
        internal readonly UInt32 pn15;
        ...
        public uint512(byte[] vch, bool lendian = true)
        {
            ...
            {
                throw new FormatException("the byte array should be 64 bytes long");
            }
